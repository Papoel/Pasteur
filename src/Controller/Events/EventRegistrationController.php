            ...
            if ($reservedPlaces <= $event->getCapacity()) {
                ...
                if (empty($details_inscription)) {
                    $details_inscription = [
                        ...
                        'evenement_date' => $event->getStartsAt()->format(format: 'd/m/Y'),
                        'evenement_debut' => $event->getStartsAt()->format(format: 'H:i'),
                        'evenement_fin' => $event->getFinishAt()->format(format: 'H:i'),
                        'evenement_lieu' => $event->getLocation(),
                        ...
                        'date_inscription' => $registration->getCreatedAt()->format(format: 'd/m/Y \à\ H:i'),
